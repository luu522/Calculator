...
# Scenario Outline: Using the previous result in a new operation                                             HECHO
# Given in the display screen the number <firstNumber> is shown
# When the user presses <Button>
# And the user writes the number <secondNumber>
# And the user presses the =
...
# Scenario Outline: Using the previous result in a new operation easier                                       HECHO
# Given in the display screen the number <firstNumber> is shown
# When the user presses <Button>
# And the user writes the number <secondNumber>
# And the user presses <Button2>
...
# Scenario Outline: Division with 0                                                                            HECHO
# Given in the display screen the number <numberOnScreen> is shown
# And the user press /
...
# Scenario: Doing an operation without a second number                                                          HECHO                                                       
# Given in the display screen the number 23 is shown
# And the user press +
# And the user press the = 
# Then the display screen should show ERROR

# Scenario: Doing an operation without a first number                                                           HECHO    
# Given the user opens the app
...
# Scenario: Button Disabled -> Do it on Figma                                                                   HECHO
